...
class GoalSettingPrayingState extends State<GoalSettingPraying> {
  ...
  Widget build(BuildContext context) {
    _init(context);
    return Scaffold(
      appBar: appBarComponent(context, Translations.of(context).trans('pray_notice_setting_title'), null, null),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Flexible( 
                    ...
                    child:
                      TextField(
                        controller: _textController,onSubmitted: _handleSubmitted,
              ...
              // QT Time Box
              timeBox(context, Translations.of(context).trans('praying_time'), visibleVar, _setHour, _setMinute, AppColors.mint,  
                () => {
                    // Time picker
                    showModalBottomSheet(
                      context: context,
